...
from script_utils import load_models_from_command_line, parse_fasta, run_model, prep_output, relax_protein
...
def main(args):
    ...
    for model, output_directory in model_generator:
        ...
        for (tag, tags), seqs in sorted_targets:
            ...
            with torch.no_grad():
                out = run_model(model, processed_feature_dict, tag, args.output_dir,args.model_dir)
            ...
            if args.model_dir is not None:
                protein_save_path = args.model_dir+'protein.pth'
                print('protein save path',protein_save_path)
                protein_data = {
                    'processed_feature_dict':processed_feature_dict,
                    'feature_dict':feature_dict,
                    'feature_processor':feature_processor,
                    'config_preset':args.config_preset,
                    'multimer_ri_gap':args.multimer_ri_gap,
                    'subtract_plddt':args.subtract_plddt,
                }
                torch.save(protein_data,protein_save_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Path to save structure, aux_head and protein module"
    )
